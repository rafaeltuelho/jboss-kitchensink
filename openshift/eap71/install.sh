...
find $JBOSS_HOME/modules -type d -name "wildfly-jsf-injection*.jar" \
 -exec cp {}/*.jar $JBOSS_HOME/modules/system/layers/openshift/org/jboss/as/jsf-injection/wildfly-jsf-injection.jar \;

find $JBOSS_HOME/modules -type f -name "weld-core-jsf*.jar" \
 -exec cp {} $JBOSS_HOME/modules/system/layers/openshift/org/jboss/as/jsf-injection/weld-core-jsf.jar \;
